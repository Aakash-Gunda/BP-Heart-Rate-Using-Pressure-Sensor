/*
* Project:    Embedded Challange
* File:       main.c
* Author(s):  Aakash Gunda

main.cpp : Gets the data from the pressure sensor and prints from serial.
PY-serial.py : Reads the data from serial using "serial" library in python and writes data into pressure_data.txt.
Sys_Dias_from_data.py : OMW wave is obtained by detrending and BP, heart rate is calculated.
*/
